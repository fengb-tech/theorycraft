...
const PATH = {
  dest:   'public/assets',
  tc:     ['lib/client/tc.js'],
  vendor: ['bower_components/core.js/client/shim.js', 'bower_components/react/react.js'],
}
...
gulp.core.task('assets', ['assets:tc.js', 'assets:vendor.js'])

gulp.core.task('watch:assets', ['watch:assets:tc.js', 'watch:assets:vendor.js'])

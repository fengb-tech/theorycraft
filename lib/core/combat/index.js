...
module.exports = class Combat {
  ...
  *runner(){
    for(var [time, attackers] of generator.timeoutIters(this.runTimeout, this.schedule)){
      for(let attacker of attackers){
        if(this.state.isActive(attacker)){
  ...
  nextEnemy(){
    return this.enemies.find((enemy) => this.state.isActive(enemy))
  }
